...
const values = {
  ...
  farmer: {
    attribute: { group: "body", sub: "endurance", value: 1 },
    skill:     { path: "body.endurance.fortitude", value: 1 },
    resources: { vitality: 8, mana: 4, stamina: 6 }
  },

  hunter: {
    attribute: { group: "mind", sub: "insight", value: 1 },
    skill:     { path: "mind.insight.tracking", value: 1 },
    resources: { vitality: 6, mana: 4, stamina: 8 }
  },

  fisher: {
    attribute: { group: "mind", sub: "insight", value: 1 },
    skill:     { path: "mind.insight.awareness", value: 1 },
    resources: { vitality: 6, mana: 4, stamina: 8 }
  },

  laborer: {
    attribute: { group: "body", sub: "might", value: 1 },
    skill:     { path: "body.might.athletics", value: 1 },
    resources: { vitality: 8, mana: 4, stamina: 6 }
  },
  ...
  merchant: {
    attribute: { group: "soul", sub: "presence", value: 1 },
    skill:     { path: "soul.presence.persuasion", value: 1 },
    resources: { vitality: 4, mana: 8, stamina: 6 }
  },

  shepherd: {
    attribute: { group: "mind", sub: "insight", value: 1 },
    skill:     { path: "mind.insight.perception", value: 1 },
    resources: { vitality: 6, mana: 6, stamina: 4 }
  },

  gravedigger: {
    attribute: { group: "body", sub: "endurance", value: 1 },
    skill:     { path: "soul.resolve.composure", value: 1 },
    resources: { vitality: 8, mana: 6, stamina: 4 }
  },
  ...
  messenger: {
    attribute: { group: "body", sub: "swiftness", value: 1 },
    skill:     { path: "body.might.athletics", value: 1 },
    resources: { vitality: 4, mana: 6, stamina: 8 }
  },

  woodcutter: {
    attribute: { group: "body", sub: "might", value: 1 },
    skill:     { path: "body.might.heft", value: 1 },
    resources: { vitality: 8, mana: 4, stamina: 6 }
  },

  cook: {
    attribute: { group: "mind", sub: "focus", value: 1 },
    skill:     { path: "soul.grace.improvisation", value: 1 },
    resources: { vitality: 4, mana: 8, stamina: 6 }
  },

  conscript: {
    attribute: { group: "body", sub: "endurance", value: 1 },
    skill:     { path: "mind.focus.tactics", value: 1 },
    resources: { vitality: 8, mana: 6, stamina: 4 }
  },

  // NOTE: milkmaid, field_hand, field_guide removed per your instruction.
...
const commonKeys = [
  ...
  "stable_hand","messenger","woodcutter","cook","conscript"
];
